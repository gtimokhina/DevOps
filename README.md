...
# {
#     "repository": {
#         "repositoryArn": "arn:aws:ecr:us-east-2:123456789012:repository/retail-store/ui",
#         "repositoryName": "retail-store/ui",
#         "repositoryUri": "123456789012.dkr.ecr.us-east-2.amazonaws.com/retail-store/ui"
#     }
# }
```
...
```yaml
image:
  repository: 180789647333.dkr.ecr.us-east-2.amazonaws.com/retail-store/ui
...
```bash
# Latest tag (mutable)
180789647333.dkr.ecr.us-east-2.amazonaws.com/retail-store/ui:latest

# SHA tag (immutable - used in production)
180789647333.dkr.ecr.us-east-2.amazonaws.com/retail-store/ui:sha-a1b2c3d
```
